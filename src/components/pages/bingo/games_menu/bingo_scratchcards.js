...
class BingoScratchcards extends React.Component {
    constructor(props) {
        super(props);
    }
    render() {
            ...
            <div className="games_list_bingo">
                <div className="GamesProd">
                    <div className="ProdImageWrapper">
                        <img src="/img/ScratchnGoWorldCup_420x420.jpg" alt="World Cup Scratch n Go"/>
                        <div className="prodJackpot"></div>
                    </div>
                    <div className="ProdDetailsWrapper">
                        <img src="/img/ScratchnGoWorldCup_200x151.jpg" alt="Prod Detail"/>
                        <table className="ProdDetailsTable">
                            <tbody>
                            <tr>
                                <td className="PromotionalText">
                                    Net a win when you match three symbols.
                                </td>
                    ...
                    <div className="ProdName">World Cup Scratch n Go</div>
                </div>
                <div className="GamesProd">
                    <div className="ProdImageWrapper">
                        <img src="/img/BigTopBonus_420x420.jpg" alt="Big Top Bonus"/>
                        <div className="prodJackpot"></div>
                    </div>
                    <div className="ProdDetailsWrapper">
                        <img src="/img/BigTopBonus_Aug18_200x151.jpg" alt="Prod Detail"/>
                        <table className="ProdDetailsTable">
                            <tbody>
                            <tr>
                                <td className="PromotionalText">
                                    Roll up to the circus and match the symbols.
                                </td>
                    ...
                    <div className="ProdName">Big Top Bonus</div>
                </div>
                <div className="GamesProd">
                    <div className="ProdImageWrapper">
...
export default BingoScratchcards;