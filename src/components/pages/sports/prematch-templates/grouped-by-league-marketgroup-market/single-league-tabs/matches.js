...
class Matches extends React.Component {
    ...
    render() {
        ...
        console.log(this.state.singleLeagueData);
                                        ...
                                        return hasMatches ?
                                            <div  key={date} className="MarketGroupContainer MarketGroupContainer_HasLabels">
                                                <div className="header_wrapp">
                                                    <div className={`MarketCouponFixtureLabelBase Market_General Market_HasLabels ${currentMarketLength === 3 ? "three_col" : ""}`}>
...

                                                    {
                                                        (currentMarketLength  == 2 || currentMarketLength  == 3) ?
                                                            <div key={`titles-${betTitles[0] ? betTitles[0] : 1}-${date}`}
                                                                 className="MarketCouponValuesExplicit33 Market_General Market_PWidth-12-3333">
