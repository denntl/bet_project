...
import OneGamesTennis from "../../shared/tables/prematchTemplates/oneSportGamesBets/oneGamesTennis";
import TennisHeader from "../../shared/tables/topHeader/tennisHeader";
import TennisTemplate from "../../shared/tables/prematchTemplates/sportsMarketTemplate/tennisTemplate";
                    ...
                    <div className="tab-content">
                        ...
                        <div className="tab-pane active" id="all">
                            ...
                            <section id="Coupons-panel" className="ContentPlate">
                                <TennisTemplate allEvents={this.state.allEvents}
            ...
            <div className="inner-wrapper">

                {
                    this.state.currentLeagueId === false ?
                        <Route  path="/sports/tennis/" render={() => this.mainSoccer() } />

                        //<Route   path="/sports/soccer/" render={() => this.mainSoccer() } />
                        :
                        <Route  path="/sports/tennis/leagues" render={() =>  <OneGamesTennis
                            marketsCol={this.marketsCol}
                            leagueName={this.state.leagueName}
