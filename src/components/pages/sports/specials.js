...
super(props);
    ...
    render() {
        return(
            <div id="page_specials"  className="page">
                <div  className="header">
                    <div  className="title ClassificationName">Specials</div>
                            ...
                            <div  className="tab-pane active" id="all">
                                <div  className="MarketGroup">
                                    <div  className="MarketGroup-GroupName" data-toggle="collapse" data-target="#collapse_LOL_World_Champs" aria-expanded="false" aria-controls="collapse_LOL_World_Champs">
                                        <div  className="Market-GroupName">Chess World Championship 2018</div>
                                ...
                                <div  className="MarketGroup">
                                    <div  className="MarketGroup-GroupName" data-toggle="collapse" data-target="#collapse_LOL_World_Champs" aria-expanded="false" aria-controls="collapse_LOL_World_Champs">
                                        <div  className="Market-GroupName">The 91st Annual Academy Awards 2019</div>
                                    </div>
                                    <div  className="Market-Cluster collapse show" id="collapse_LOL_World_Champs" aria-expanded="true">
                                        <div  className="item"><label className="checkbox"><input type="checkbox" className="item-checkbox"  /><span className="checkmark"></span></label><a href="#" className="CouponLink_Label">The 91st Annual Academy Awards 2019</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
