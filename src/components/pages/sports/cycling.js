...
super(props);
    ...
    render() {
        return(
            <div id="page_cycling" className="page">
                <div className="header">
                    ...
                    <div className="title ClassificationName">Cycling</div>
                            ...
                            <div className="tab-pane fade show active" role="tabpanel" id="all">
                                <section id="" className="ContentPlate">
                                    <div className="MarketGroup">
                                        <div className="MarketGroup-GroupName" data-toggle="collapse" data-target="#collapse_Tour_de_France_2019" aria-expanded="false" aria-controls="collapse_Tour_de_France_2019">
                                            <div className="Market-GroupName">Tour de France 2019</div>
                                        </div>
                                        <div className="Market-Cluster collapse show" id="collapse_Tour_de_France_2019" aria-expanded="true">
