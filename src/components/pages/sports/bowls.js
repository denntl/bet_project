...
super(props);
    ...
    render() {
        return(
            <div id="page_bowls" className="page">
                <div className="header">
                    ...
                    <div className="title ClassificationName">Bowls</div>
                                ...
                                <section id="" className="ContentPlate">
                                    <div className="MarketGroup">
                                        <div className="Market">
                                            <div className="MarketGroup-GroupName" data-toggle="collapse" data-target="#collapse_Scottish_Open_2018" aria-expanded="false" aria-controls="collapse_Scottish_Open_2018">
                                                <div className="Market-GroupName">Scottish Open 2018</div>
                                            ...
                                            <div className="Market-Cluster collapse show" id="collapse_Scottish_Open_2018" aria-expanded="true">
                                                <div  className="item"><label className="checkbox"><input type="checkbox" className="item-checkbox"  /><span className="checkmark"></span></label><a href="#" className="CouponLink_Label">Round 1 Matches</a></div>
