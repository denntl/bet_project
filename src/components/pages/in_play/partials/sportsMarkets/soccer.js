...
class Soccer extends React.Component {
    ...
    /** Удалить из кода **/
    components = {
        // "Asian Handicap 1st Period": MAsianHandicap1stPeriod,
        // "Asian Handicap": MAsianHandicap,
    }
                               ...
                               // console.log("!!!!!!!!!!!!!2222222222222222", currentMarketName)
                                ...
                                if (this.state.markets[id].Name == currentMarketName || this.state.fromEventView) {
                                    ...
                                    if (typeof this.state.markets[id].template != 'undefined') {
                                        ...
                                        if (typeof  this.components[currentMarketName] == "undefined") {
                                            // console.log('!!! Undefined this.state.market.Id: ' + this.state.markets[id].Id + ' ' + this.state.markets[id].Name);

                                        } else {
                                            const TagName = this.components[currentMarketName];
