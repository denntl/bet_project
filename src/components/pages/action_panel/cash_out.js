...
class Cash_out extends React.Component {
    ...
    render() {
        console.log("ACTIONbets", this.state.bets);
        return(
            <div>
                {
                    this.state.bets && this.state.bets.length ?
                            ...
                            </div>
                            {
                                ...
                                this.state.bets.map((bet, ind) => {
                                    ...
                                    if (typeof bet.bets != "undefined") {
                                        return  <div className={`settled_tab ${'my_bets_table-' + bet.id}`} key={ind}>
                                            ...
                                            <div className="OpenBetItem">
                                                ...
                                                <div className={`OpenBetItem_details id-${bet.id}`}>
                                                    ...
                                                    <div className="stakeToReturnWrapper">
                                                    ...
                                                    <div className="stakeToReturnContainer">
                                                        ...
                                                        <div className="CloseBetButton" onClick={() => this.cashoutBetClick(true, bet.id)}>
                                                            <div className="CloseBetButton_wrapp">
                                                                <div className={`button_cash_out my_bets active ${"button_cash_out-" + bet.id}`}>
                                                                    <span className="button_cash_text">Cash out</span>
                                                                    {this.state.cashOutValue["button" + bet.id] ?
                                                                        <span className="cash">{this.state.cashOutValue["button" + bet.id] } <span className="currency">EUR</span> </span>
                                                                        : <span style={{color: "#116b4f", fontSize: '12px'}}>{bet.amount_to_cashout} EUR</span>
                                                                    }
                                                                </div>
                                        ...
                                        return  <div className={`settled_tab ${'my_bets_table-' + bet.id}`} key={ind}>
                                            <div className="OpenBetItem">
                                                ...
                                                <div className={`OpenBetItem_details id-${bet.id}`}>
                                                    ...
                                                    <div className="CloseBetButton" onClick={() => this.cashoutBetClick(false, bet.id)}>
                                                        <div className="CloseBetButton_wrapp">
                                                            <div className={`button_cash_out my_bets active ${"button_cash_out-" + bet.id}`}>
                                                                <span className="button_cash_text">Cash out</span>
                                                                {this.state.cashOutValue["button" + bet.id] ?
                        ...
                        :
                        <div className="EmptyMsg">You have no bets available for Cash Out
