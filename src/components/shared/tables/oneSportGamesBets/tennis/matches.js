...
class Matches extends React.Component {
    ...
    render() {
        ...
        console.log('matches теннис', this.state);
                                                            ...
                                                            <div className="content_wrapp" key={`${eventId}`}>
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <NavLink to="/sports/tennis/leagues/game" className="CouponParticipantWithBookCloses_Name" onClick={() => this.props.showOneGame(this.state.currentEvents[eventId], this.state.currentEvents)}>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <NavLink to="/sports/tennis/leagues/game"
                                                                                 className="CouponFixtureLinkParticipant_Name" onClick={() => this.props.showOneGame(this.state.currentEvents, this.state.currentEvents[eventId])}>{this.state.currentEvents[eventId].Markets.length}
                                                                        </NavLink>
                                                                    </div>
                                                                </div>
                                                            </div>
