...
class BasketballTemplate extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    // }
    toggleLocation(id) {
        console.log(123123, $('#loc_'+id).hasClass('none'));
...
console.log(2222, this.state.allEvents[leagueId]['groups'][groupName]['markets']);
                                        ...
                                        <div key={marketId} className="item">
                                            ...
                                            <NavLink className="CouponLink_Label" to="/sports/basketball/leagues"
                                                  ...
                                                  console.log(this.state.allEvents[leagueId]['name'])
...
export default BasketballTemplate;