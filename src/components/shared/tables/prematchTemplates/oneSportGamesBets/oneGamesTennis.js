...
import TennisHeader from "../../topHeader/tennisHeader";
import {getEventsGroupedByMarket, getMarkets} from "../../../../helpers/data";
import moment from "moment/moment";
import {Route} from "react-router-dom";
import Matches from "../../oneSportGamesBets/tennis/matches";
import Outrights from "../../oneSportGamesBets/tennis/outrights";



class  OneGamesTennis extends React.Component {
       ...
       // console.log('OnesportGamesBets', this.state)
        return(
            <div  className="inner-wrapper">
                <Route exact path="/sports/tennis/leagues" render={() => this.match() } />

                <Route  path="/sports/tennis/leagues/game" render={() =>   <OneGamesBets activeFilter={this.state.activeFilter} changeGame={(id) => this.changeGame(id)} showForm={(type, kind) => this.props.showForm(type, kind)} currentGame={this.state.currentGame} sportName={this.state.sportName} leagueName={this.state.leagueName} allEventsDate={this.state.allEventsDate} sportId={this.state.sportId}  addToBetSlip={(info, bet, typeBet) => this.props.addToBetSlip(info, bet, typeBet)}/>} />
